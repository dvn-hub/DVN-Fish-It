...
local function loadFishDataLegacy()
    pcall(function()
        ...
        print("🐟 Public Logger: Loaded " .. count .. " fish images.")
    end)
end
...
local function loadFishData()
    ...
    if itemsFolder then
        ...
        warn("Public Logger: Items folder not found, trying full ReplicatedStorage scan.")
    end
    ...
    print("ðŸŸ Public Logger: Loaded " .. count .. " fish images.")
end
